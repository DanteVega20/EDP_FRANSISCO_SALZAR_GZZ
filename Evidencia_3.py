                            ...
                            with sql.connect('Evidencia_3.db') as conn:
                                ...
                                if paciente_Encontrado:
                                    ...
                                    if pregunta_expediente_clinico == 'SI':
                                        mi_cursor.execute('SELECT edad, peso, estatura, horaLlegada, presionArterial, diagnostico FROM Citas WHERE clave_paciente = ?', (clave_buscar,))
                                        expediente_clinico = mi_cursor.fetchall()
                                        if expediente_clinico:
                                            for edad, peso, estatura, horaLlegada, presionArterial, diagnostico in expediente_clinico:
                            ...
                            with sql.connect('Evidencia_3.db') as conn:
                                ...
                                if pacientes_encontrados:
                                    ...
                                    if pregunta_expediente_clinico == 'SI':
                                        ...
                                        mi_cursor.execute('SELECT edad, peso, estatura, horaLlegada, presionArterial, diagnostico FROM Citas WHERE clave_paciente = ?', (clave_expediente,))
                                        expediente = mi_cursor.fetchall()
                                        for edad, peso, estatura, horaLlegada, presion, diagnostico in expediente:
                                        ...
                                        print('Este paciente no tiene expediente clínico registrado.')
                    ...
                    if opcion_stats == 1:
                        ...
                        while True:
                            try:
                                ...
                                print(f'El dato ingresado {edad_inicio} no es numerico. Intente de nuevo')
                        while True:
                            try:
